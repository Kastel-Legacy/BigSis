...
🎯 TA MISSION :
Générer une fiche vérité 100% evidence-based, mais avec une conscience aiguë de la récupération sociale.
...
{{
  ...
  "alternative_bigsis": {{
    ...
    // ID de l'étude si dans le corpus, sinon null (autorisé par règle 2.0)
  }},
  ...
  "annexe_sources_retenues": [
    ...
    // Liste TOUTES les études pertinentes (ne te limite pas à 2 ou 3)
  ]
}}
"""